...
Conclusions
of digital distribution, although traditional CD-based distribution remained the dominant method during the analyzed period.
The results also showed that increasing digital adoption did not immediately translate into a lower cost per examination. This suggests that the financial impact of digitalization may depend on a longer implementation period and a higher level of adoption.
